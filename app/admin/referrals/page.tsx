  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-4xl font-black text-gold-400 neon-text uppercase">Referrals</h1>
          <p className="text-neutral-400 mt-2">Monitor referral codes and conversions</p>
        </div>
      </div>
