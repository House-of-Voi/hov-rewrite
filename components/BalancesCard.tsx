      ...
      <Card>
        <CardContent className="p-6">
          <div className="flex items-center justify-center py-8">
            <p className="text-neutral-600 dark:text-neutral-400">Loading balances...</p>
          </div>
        </CardContent>
      </Card>
    );
      ...
      <Card>
        <CardHeader>
          <div className="flex items-center justify-between">
            <h2 className="text-2xl font-bold text-warning-500 dark:text-warning-400 uppercase">Your Balances</h2>
            <button
        ...
        <CardContent className="space-y-6">
          ...
          <div>
            ...
            <div className="p-6 rounded-xl bg-gradient-to-br from-primary-100 dark:from-primary-600/20 via-accent-100 dark:via-accent-600/20 to-warning-100 dark:to-warning-500/20 border-2 border-warning-300 dark:border-warning-500/30">
              <div className="text-center space-y-4">
                <div className="space-y-1">
                  <div className="text-xs text-neutral-600 dark:text-neutral-400 uppercase tracking-wider">USDC</div>
                  <div className="text-5xl font-black text-warning-500 dark:text-warning-400 font-mono">
                ...
                {depositStatus && (
                  <div className="p-3 bg-primary-100 dark:bg-primary-500/20 border border-primary-300 dark:border-primary-500/30 rounded-lg">
                    <p className="text-sm text-primary-600 dark:text-primary-400 text-center">{depositStatus}</p>
                  </div>
                )}
          ...
          {/* Helper Text */}
          <p className="text-xs text-neutral-600 dark:text-neutral-500 text-center">
