    ...
    return (
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        {[...Array(4)].map((_, i) => (
          ...
          >
            <div className="h-4 bg-gold-900/20 rounded w-24 mb-4"></div>
            <div className="h-8 bg-gold-900/20 rounded w-32"></div>
          </div>
        ))}
      </div>
    );
    ...
    <div className="space-y-6">
      <div className="bg-gradient-to-r from-gold-500/10 to-gold-600/5 border border-gold-900/20 rounded-xl p-6">
        <div className="flex flex-col sm:flex-row gap-4 sm:items-center sm:justify-between mb-4">
          <div>
            <h2 className="text-2xl font-bold text-gold-400 mb-1">
              {machineDisplayName}
            </h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        {statCards.map((stat) => (
          <div
            key={stat.label}
            className="bg-gradient-to-br from-neutral-900/50 to-neutral-950 border border-gold-900/20 rounded-xl p-6 hover:border-gold-900/40 transition-all"
          >
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div className="bg-gradient-to-br from-neutral-900/50 to-neutral-950 border border-gold-900/20 rounded-xl p-6">
          <h3 className="text-lg font-bold text-gold-400 mb-4">Activity</h3>
          <div className="space-y-3">
            <div className="flex justify-between items-center">
              <span className="text-neutral-400 text-sm">Winning Spins</span>
              <span className="text-gold-400 font-semibold">
                {formatNumberCompact(stats.total_winning_spins)}
              </span>
            </div>
            <div className="flex justify-between items-center">
              <span className="text-neutral-400 text-sm">Losing Spins</span>
        ...
        <div className="bg-gradient-to-br from-neutral-900/50 to-neutral-950 border border-gold-900/20 rounded-xl p-6">
          <h3 className="text-lg font-bold text-gold-400 mb-4">Betting Stats</h3>
          <div className="space-y-3">
            <div className="flex justify-between items-center">
              <span className="text-neutral-400 text-sm">Avg Bet Size</span>
              <span className="text-neutral-300 font-semibold">
                {(stats.average_bet_size / 1_000_000).toFixed(2)} VOI
              </span>
            </div>
            <div className="flex justify-between items-center">
              <span className="text-neutral-400 text-sm">Largest Bet</span>
              <span className="text-neutral-300 font-semibold">
