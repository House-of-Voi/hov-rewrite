...
export default function GameTypeTotalsGrid({ gameTypeTotals }: GameTypeTotalsGridProps) {
  ...
  return (
    <div>
      <h2 className="text-2xl font-black text-warning-500 dark:text-warning-400 uppercase mb-4 neon-text">
            ...
            <Card key={gameTypeTotal.game_type}>
              ...
              <CardContent>
                <div className="space-y-3">
                  ...
                  <div className="grid grid-cols-2 gap-4 pt-3 border-t border-warning-200 dark:border-warning-900/20">
                    <div>
